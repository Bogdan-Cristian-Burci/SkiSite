            ...
            <div class="row row-6 row-x-6" data-lightgallery="group">
                ...
                @foreach($galleries as $gallery)
                    <div class="col-md-4 col-sm-6 col-12">
                        <a class="thumbnail-light" href="{{ asset($gallery->image_path) }}" data-lightgallery="item">
                            <span class="caption">{{ $gallery->title }}</span>
                            <img class="thumbnail-light-image" src="{{ asset($gallery->image_path) }}" alt="{{ $gallery->title }}" width="383" height="290"/>
                        </a>
                    </div>
                @endforeach
            </div>
