...
@push('scripts')
    @push('scripts')
        ...
        <script>
            // Add this to your index.blade.php in the @push('scripts') section
            ...
            function initializeSlickSliders() {
                ...
                jQuery('.slick-slider-1').each(function() {
                    ...
                    // Get data attributes
                    var dataLoop = $slider.attr('data-loop') === 'true';
                    var dataAutoplay = $slider.attr('data-autoplay') === 'true';
                    var dataDots = $slider.attr('data-dots') === 'true';
                    var dataSwipe = $slider.attr('data-swipe') === 'true';
                    var dataItems = parseInt($slider.attr('data-items')) || 1;
                    var dataXsItems = parseInt($slider.attr('data-xs-items')) || 1;
                    var dataSmItems = parseInt($slider.attr('data-sm-items')) || 1;
                    var dataMdItems = parseInt($slider.attr('data-md-items')) || 3;
                    var dataLgItems = parseInt($slider.attr('data-lg-items')) || 3;
                    var dataXlItems = parseInt($slider.attr('data-xl-items')) || 3;
                    var dataCenterMode = $slider.attr('data-center-mode') === 'true';
                    var dataSpeed = parseInt($slider.attr('data-speed')) || 600;
                            ...
                            responsive: [
                                {
                                    breakpoint: 0,
                                    settings: {
                                        slidesToShow: dataXsItems
                                    }
                                },
                                {
                                    breakpoint: 575,
                                    settings: {
                                        slidesToShow: dataSmItems
                                    }
                                },
                                {
                                    breakpoint: 767,
                                    settings: {
                                        slidesToShow: dataMdItems
                                    }
                                },
                                {
                                    breakpoint: 991,
                                    settings: {
                                        slidesToShow: dataLgItems
                                    }
                                },
                                {
                                    breakpoint: 1199,
                                    settings: {
                                        slidesToShow: dataXlItems
                                    }
                                }
                            ]
                        });
            ...
            // Force re-initialization function (can be called manually if needed)
            window.forceSlickReInit = function() {
                jQuery('.slick-slider-1').each(function() {
                    var $slider = jQuery(this);
                    if ($slider.hasClass('slick-initialized')) {
                ...
                setTimeout(initializeSlickSliders, 100);
            };
        </script>
@endpush
